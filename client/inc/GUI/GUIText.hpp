...
public:
    GUIText();
    GUIText (SDL_Renderer* r, TTF_Font* f);
    ~GUIText ();
    void createTexture(const string& text);
    ...
    inline GUIText* setText(const string& text) { m_text = text; m_shouldUpdate = true; return this;}
};
